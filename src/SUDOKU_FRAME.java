...
public class SUDOKU_FRAME extends javax.swing.JFrame {
   ...
   Stack<HashMap<JButton,String>> st = new Stack<>();
    ...
    private void Undo(){
        if(st.isEmpty()){
            JOptionPane.showMessageDialog(this,"Please enter a value befor using the Undo fuction","Sudoku Game",JOptionPane.INFORMATION_MESSAGE); 
        }
        else{
            ...
            while(!st.isEmpty()){
             ...
             while(!tempSt.isEmpty()){
                 HashMap<JButton,String> temp1 = tempSt.pop();
                 st.push(temp1);
             }
        }
    }
   public void changeNumber(JButton btn){
   ...
   public void reset(){
    ...
    private void initComponents() {
        ...
        jButton94.setBackground(new java.awt.Color(0, 255, 51));
        jButton94.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        ...
        checkmoves.setBackground(new java.awt.Color(255, 153, 153));
    ...
    private void resetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetActionPerformed
        // TODO add your handling code here:
        if(JOptionPane.showConfirmDialog(this,"If you want to reset","SUDOKU",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION){
            reset();
        }
